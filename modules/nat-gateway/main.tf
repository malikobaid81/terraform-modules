# allocate elastic ip. This will be used for the nat-gateway in the public subnet az1 
resource "aws_eip" "eip_for_nat_gateway_az1" {
  domain = "vpc"

  tags   = {
    Name = "${var.project_name}-${var.environment}-Nat-GW-az1-eip}"
  }
}
...
resource "aws_eip" "eip_for_nat_gateway_az2" {
  ...
  tags   = {
    Name = "${var.project_name}-${var.environment}-Nat-GW-az2-eip}"
  }
}
